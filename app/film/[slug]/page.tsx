...
import { Star, Clock, Play, Download } from "lucide-react";
...
export default async function MoviePage({ params }: Props) {
  ...
  const StreamButton = () => (
    <div className="flex flex-col gap-3 w-full max-w-md">
      <button className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition-colors">
        <Play className="w-5 h-5" />
        Regarder en streaming
      </button>
      <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition-colors">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 pt-[20vh]">
          <div className="grid md:grid-cols-[300px,1fr] gap-8">
            ...
            <div className="relative z-10">
              <h1 className="text-4xl font-bold mb-4">{movie.title} en Streaming Film Complet VF en HD</h1>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-lg text-white/80 mb-6">{movie.overview}</p>
                  <StreamButton />
                </div>
                ...
                <div>
                  <h2 className="text-2xl font-semibold mb-4">
                    Regarder {movie.title} en Streaming
                  </h2>
